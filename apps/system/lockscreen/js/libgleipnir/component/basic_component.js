...
(function(exports) {
   ...
   */
  var GleipnirBasicComponent = function(view) {
    ...
    this.logger = new GleipnirStateLogger();
    this.view = view;
  };
   ...
   */
  GleipnirBasicComponent.prototype.phase =
  function() {
   ...
   */
  GleipnirBasicComponent.prototype.transferTo = function(clazz, reason = {}) {
   ...
   */
  GleipnirBasicComponent.prototype.start = function(resources) {
   ...
   */
  GleipnirBasicComponent.prototype.setup = function(component) {};

  GleipnirBasicComponent.prototype.stop = function() {
    return this._activeState.stop()
      .next(this.waitComponents.bind(this, 'stop'));
  };

  GleipnirBasicComponent.prototype.destroy = function() {
  ...
  GleipnirBasicComponent.prototype.live = function() {
    return this._activeState.until('stop');
  };

  GleipnirBasicComponent.prototype.exist = function() {
   ...
   * setup stage.
   */
  GleipnirBasicComponent.prototype.waitComponents = function(method, args) {
   ...
   */
  GleipnirBasicComponent.prototype.render = function(props, target) {
    return this.view.render(props, target);
  };

  exports.GleipnirBasicComponent = GleipnirBasicComponent;
})(window);
